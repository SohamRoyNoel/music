        ...
        <div class="music-browse">
            ...
            <div class="browse">
                <div class="tittle-head two">
                    <h3 class="tittle">Artists <span class="new">Find All</span></h3>
                    <?php
                        if (isset($_POST['xxx'])){
                            echo  "boat";
                        }
                            ...
                            <div class="browse-inner">
                                ...
                                <?php
                                    ...
                                    if (isset($_SESSION['language_to_artist_album'])) {
                                        ...
                                        $sql = "select * from artist where language = $lng";
                                        ...
                                        while ($r = mysqli_fetch_assoc($make)) {
                                            ...
                                            $image = $r['image'];
                                            $language = $r['language'];
                                            $_SESSION['to_show_songs_copy'] = $language;
                                            ?>
                                            <div class="col-md-3 artist-grid">
                                                <a href="show_songs_copy.php?name=<?php echo $title; ?>"><img height='200' width='320' src="artist_image/<?php echo $image; ?>" title="<?php echo $title; ?>"></a>
