...
<div id="page-wrapper">
    <div class="inner-content single">
        ...
        <div class="tittle-head">
            <h3 class="tittle">ALL Albums <span class="new">Admin's Control Panel</span></h3>
        </div>
    </div>
    <br><br><br>
    ...
    <table class="table table-responsive table-hover">
        ...
        $sql12 = "select * from artist where id=$artist";
        $getter12 = mysqli_query($connection,$sql12);
        while ($r=mysqli_fetch_assoc($getter12)){
            $artist=$r['name'];
        }
        ...
        <td><input class='checkbox' type='checkbox' name='checkBoxArray[]' value='<?php echo $id ?>'>
            ...
            echo "<td>{$artist}</td>";
            echo "<td>{$language}</td>";
            echo "<td><a href='../edit_album.php?update=$crypted_id_for_edit' class='active' ui-toggle-class=''><i class='fa fa-edit' title='Edit'></i></a><br><br><a href='manipulate.php?deletek=$id' class='active' ui-toggle-class=''><i class='lnr lnr-trash' title='Delete'></i></a></td>";
            echo "</tr>";
            }
            ?>
        </tbody>
